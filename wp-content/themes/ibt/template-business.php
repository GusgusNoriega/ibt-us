...
$texto_del_boton_3 = get_field('titulo_del_boton_3');
...
$parrafo_2 = get_field('parrafo_2');
$texto_del_boton_2 = get_field('texto_del_boton_2');
$enlaace_del_boton_2 = get_field('enlaace_del_boton_2');
?>
...
<section class="mt-[50px] sm:mt-[80px]" id="residential_plans">
    <div class="container-w" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
        <h2 class="text-center font-beVietnam text-[24px] sm:text-[30px] font-medium text-darkGray" data-aos="fade-up"
        ...
        <div
            class="grid grid-cols-[repeat(auto-fill,_minmax(260px,_1fr))] md:grid-cols-3 gap-[40px] md:gap-[15px] xl:gap-[40px] mb-[25px]">
...
<section class="mt-[50px] sm:mt-[80px]">
    <div class="container-w">
        ...
        <p class="text-[16px] text-center mt-[15px] mb-[50px] font-normal text-darkGray" data-aos="fade-up"
            data-aos-duration="1000" data-aos-once="true">
            <?php echo $parrafo_2;?>
        </p>
        <div class="grid grid-cols-[repeat(auto-fill,_minmax(250px,_1fr))] gap-x-6 gap-y-6" data-aos="fade-up"
            data-aos-duration="1000" data-aos-once="true">

            <?php if( have_rows('opciones') ): ?>
            <?php while( have_rows('opciones') ): the_row(); 
                            $imagen = get_sub_field('imagen');
                            $titulo = get_sub_field('titulo');
                            $parrafo = get_sub_field('parrafo');
                        ?>
            <div class="w-full max-w-[325px] mx-auto">
                <div class="rounded-t-[20px] w-full h-[215px]">
                    <img src="<?php echo esc_url($imagen['url']); ?>" alt="<?php echo esc_attr($imagen['alt']); ?>"
                        class="w-full h-full" />
                </div>
                <div class="p-[18px] bg-[#F0F4F8] rounded-b-[20px] sm:h-[200px]">
                    <p class="font-beVietnam text-[18px] font-semibold text-darkGray">
                        <?php echo esc_html($titulo); ?>
                    </p>
                    <p class="text-darkGray text-base font-normal mt-[10px]">
        ...
        <div class="flex justify-center mt-[50px]" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            <a href="#residential_plans" class="btn"><?php echo $texto_del_boton_3; ?></a>
        </div>
    </div>
</section>
...
<section class="mt-[50px] sm:mt-[80px]">
    <div class="container-w">
        ...
        <div class="flex flex-col md:flex-row gap-[60px] justify-center mt-[50px]" data-aos="fade-up"
            data-aos-duration="1000" data-aos-once="true">
            <div class="flex flex-col lg:flex-row items-center gap-4">
                ...
                <?php 
                            if( $icono_1 ) : 
                            ?>
                <img src="<?php echo esc_url($icono_1['url']); ?>" alt="<?php echo esc_attr($icono_1['alt']); ?>"
                    class="w-[56px] h-[56px]">
                <?php 
                            endif;
                            ?>
                <p
                    class="text-darkGray text-[16px] font-normal max-w-[286px] lg:max-w-[430px] text-center lg:text-start">
                    <?php echo $parrafo_1;?>
                </p>
            </div>
            <div class="flex flex-col lg:flex-row items-center gap-4">
                ...
                <?php 
                            if( $icono_2 ) : 
                            ?>
                <img src="<?php echo esc_url($icono_2['url']); ?>" alt="<?php echo esc_attr($icono_2['alt']); ?>"
                    class="w-[56px] h-[56px]">
                <?php 
                            endif;
                            ?>
                <p class="text-darkGray text-[16px] font-normal max-w-[286px] lg:max-w-[200px] text-center lg:text-start">
                    <?php echo $parrafo_2;?>
                </p>
            </div>
        </div>
        <div class="flex justify-center mt-[50px]">
            <a href="<?php echo $enlaace_del_boton_2;?>" class="btn" data-aos="fade-up" data-aos-duration="1000"
                data-aos-once="true">
                <?php echo $texto_del_boton_2;?>
            </a>
        </div>
    </div>
</section>
